...
## <span style="color: purple;"> 2.1)  Approach 1 </span> {#A1}
...
## <span style="color: purple;"> 2.2)  Approach 2 </span> {#A2}
...
Moreover, if one "forgets" to apply the correction, then the number of edges is too high to making it hard to draw clear conclusions.

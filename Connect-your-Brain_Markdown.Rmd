...
#```{r out.extra='style="background-color: #000000; padding:1px; display: #inline-block;"', eval=TRUE}
#knitr::include_graphics("images_bootstrap/difference_graph_normal.png")
#```
